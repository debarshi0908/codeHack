		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getListofEntitiesAccess().getEntitiesAssignment_2(), "rule__ListofEntities__EntitiesAssignment_2");
					put(grammarAccess.getMRBlockAccess().getMapperAssignment_0(), "rule__MRBlock__MapperAssignment_0");
					put(grammarAccess.getMRBlockAccess().getReducerAssignment_1(), "rule__MRBlock__ReducerAssignment_1");
					...
					put(grammarAccess.getMapperAccess().getInkeyAssignment_1(), "rule__Mapper__InkeyAssignment_1");
					put(grammarAccess.getMapperAccess().getInvalueAssignment_3(), "rule__Mapper__InvalueAssignment_3");
					put(grammarAccess.getMapperAccess().getOutkeyAssignment_5(), "rule__Mapper__OutkeyAssignment_5");
					put(grammarAccess.getMapperAccess().getOutvalueAssignment_7(), "rule__Mapper__OutvalueAssignment_7");
					...
					put(grammarAccess.getReducerAccess().getOutkeyAssignment_1(), "rule__Reducer__OutkeyAssignment_1");
					put(grammarAccess.getReducerAccess().getOutvalueAssignment_3(), "rule__Reducer__OutvalueAssignment_3");
					...
					put(grammarAccess.getReadorWriteAccess().getReadvalAssignment_0_1(), "rule__ReadorWrite__ReadvalAssignment_0_1");
					put(grammarAccess.getReadorWriteAccess().getWritevalAssignment_1_1(), "rule__ReadorWrite__WritevalAssignment_1_1");
