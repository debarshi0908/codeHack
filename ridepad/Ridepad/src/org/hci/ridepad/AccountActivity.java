...
//	//	System.out.println("##############"+str[0]+str[1]+str[2]+str[3]);
		...
		TextView streetxt = (TextView) findViewById(R.id.txtstreet);
		TextView citytxt = (TextView) findViewById(R.id.txtcity);
		TextView statetxt = (TextView) findViewById(R.id.txtstate);
		TextView ziptxt = (TextView) findViewById(R.id.txtzipcode);
